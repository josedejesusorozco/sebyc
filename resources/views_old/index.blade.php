                        ...
                        <div class="col-sm-12 col-lg-6">
                            <div class="well fill div-blue">
                                ...
                                <div class="options options-blue">
                                    ...
                                    <p>
                                        {!! Form::open(array('url'=>'importa_arboles','method'=>'POST', 'files'=>true, 'id' => 'form-arboles')) !!}
                        ...
                        <div class="col-sm-12 col-lg-6">
                            <div class="well fill div-green">
                                ...
                                <div class="options options-green">
                                    <h3><span class="small">Aquí las opciones para subir el archivo</span></h3>
                                    <p>
                                        {!! Form::open(array('url'=>'importa_modelos','method'=>'POST', 'files'=>true, 'id' => 'form-modelos')) !!}
                        ...
                        <div class="col-sm-12 col-lg-6">
                            <div class="well fill div-yellow">
                                ...
                                <div class="options options-yellow">
                                    <h3><span class="small">Aquí las opciones para subir el archivo</span></h3>
                                    <p>
                                        {!! Form::open(array('url'=>'importa_densidades','method'=>'POST', 'files'=>true, 'id' => 'form-densidades')) !!}
                        ...
                        <div class="col-sm-12 col-lg-6">
                            <div class="well fill div-red">
                                ...
                                <div class="options options-red">
                                    <h3><span class="small">Aquí las opciones para subir el archivo</span></h3>
                                    <p>
                                        {!! Form::open(array('url'=>'importa_fracciones','method'=>'POST', 'files'=>true, 'id' => 'form-fracciones')) !!}
